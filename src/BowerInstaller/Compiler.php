...
class Compiler
{
     ...
     */
    public function compile($pharFile = 'bowerphp-installer.phar')
    {
        ...
        $phar = new \Phar($pharFile, 0, 'bowerphp-installer.phar');
        ...
        $finder->files()
            ...
            ->in(__DIR__.'/../../vendor/beelab/bowerphp/')
        ;
        ...
        unset($phar);
        chmod("bowerphp-installer.phar", 0700);
    }
